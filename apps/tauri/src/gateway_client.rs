//! HTTP client for communicating with the OpsClaw gateway.
...
mod tests {
    ...
    fn client_custom_url() {
        let client = GatewayClient::new("https://opsclaw.example.com:9999", None);
        assert_eq!(client.base_url, "https://opsclaw.example.com:9999");
    }
