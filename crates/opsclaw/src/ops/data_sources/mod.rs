...
/// Fetch context from all configured data sources for a target, in parallel.
///
/// Deserializes the target's `data_sources` JSON value into a
...
pub async fn fetch_all(
    target: &zeroclaw::config::schema::TargetConfig,
    runner: Option<&dyn crate::tools::discovery::CommandRunner>,
) -> DataSourcesSnapshot {
