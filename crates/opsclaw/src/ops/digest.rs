...
impl DigestReport {
    ...
    pub fn generate(targets: Vec<ProjectInput>, period_hours: u32) -> Self {
        ...
        let target_digests: Vec<ProjectDigest> = targets
            .into_iter()
            .map(|input| {
    ...
    pub fn to_markdown(&self) -> String {
        ...
        let _ = writeln!(out, "- **Projects monitored**: {}", self.projects.len());
        let _ = writeln!(out);

        if self.projects.is_empty() && self.total_incidents == 0 {
