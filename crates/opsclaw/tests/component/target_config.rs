...
"#;
    ...
    assert_eq!(t.autonomy, OpsClawAutonomy::DryRun);
}
...
"#;
    ...
    assert_eq!(w.targets[0].autonomy, OpsClawAutonomy::Auto);
    assert_eq!(w.targets[1].autonomy, OpsClawAutonomy::DryRun);
...
fn all_autonomy_levels_parse() {
    for (input, expected) in [
        // New canonical names (kebab-case).
        ("dry-run", OpsClawAutonomy::DryRun),
        ("approve", OpsClawAutonomy::Approve),
        ("auto", OpsClawAutonomy::Auto),
        // Backward-compat aliases.
        ("observe", OpsClawAutonomy::DryRun),
        ("suggest", OpsClawAutonomy::DryRun),
        ("act_on_known", OpsClawAutonomy::Auto),
        ("full_auto", OpsClawAutonomy::Auto),
    ] {
        let toml_str = format!(
            r#"
[[targets]]
...
#[test]
fn default_autonomy_is_approve() {
    assert_eq!(OpsClawAutonomy::default(), OpsClawAutonomy::Approve);
}
