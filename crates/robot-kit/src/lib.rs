//! # OpsClaw Robot Kit
//!
//! A standalone robotics toolkit that integrates with OpsClaw for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  OpsClaw AI Brain (or any controller)                    │
...
//!
//! ```rust,ignore
//! use opsclaw_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of OpsClaw. It defines its own
//! `Tool` trait that is compatible with OpsClaw's but doesn't require it.
//!
//! ## Safety
//!
