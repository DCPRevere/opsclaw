//! Plugin manifest — `~/.opsclaw/tools/<name>/tool.toml` schema.
//!
...
/// Execution configuration — how OpsClaw spawns the tool.
#[derive(Debug, Deserialize)]
...
///
/// When present, OpsClaw will prefer the named transport kind
