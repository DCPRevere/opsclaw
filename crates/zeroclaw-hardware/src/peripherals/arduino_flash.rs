//! Flash OpsClaw Arduino firmware via arduino-cli.
//!
...
/// OpsClaw Arduino Uno base firmware (capabilities, gpio_read, gpio_write).
...
/// Flash OpsClaw firmware to Arduino at the given port.
pub fn flash_arduino_firmware(port: &str) -> Result<()> {
    ...
    // Compile
    println!("Compiling OpsClaw Arduino firmware...");
    ...
    println!("OpsClaw firmware flashed successfully.");
