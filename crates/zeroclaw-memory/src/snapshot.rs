...
const SNAPSHOT_HEADER: &str = "# 🧠 OpsClaw Memory Snapshot\n\n\
    > Auto-generated by OpsClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 OpsClaw Memory Snapshot

> Auto-generated by OpsClaw.
...
I am OpsClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 OpsClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
