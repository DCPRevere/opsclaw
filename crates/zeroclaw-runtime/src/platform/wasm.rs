...
//! The default OpsClaw binary excludes it to maintain the 4.6 MB size target.
...
impl RuntimeAdapter for WasmRuntime {
    ...
    fn storage_path(&self) -> PathBuf {
        self.workspace_dir
            .as_ref()
            .map_or_else(|| PathBuf::from(".opsclaw"), |w| w.join(".opsclaw"))
    }
...
mod tests {
    ...
    fn wasm_storage_path_with_workspace() {
        ...
        assert_eq!(rt.storage_path(), PathBuf::from("/home/user/project/.opsclaw"));
    }
