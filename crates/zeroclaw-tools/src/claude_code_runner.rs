...
/// execution events back to OpsClaw's gateway endpoint, enabling live Slack
...
pub struct ClaudeCodeRunnerTool {
    ...
    /// Base URL of the OpsClaw gateway (e.g. `"http://localhost:3000"`).
    gateway_url: String,
}
...
mod tests {
    ...
    fn shell_escape_simple() {
        ...
        assert_eq!(shell_escape("x; touch pwned"), "'x; touch pwned'");
    }
