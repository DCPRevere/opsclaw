...
Gói Python đồng hành cho [OpsClaw](https://github.com/DCPRevere/opsclaw) — gọi công cụ dựa trên LangGraph cho thực thi agent LLM nhất quán.
...
## So sánh với Rust OpsClaw

| Tính năng | Rust OpsClaw | opsclaw-tools |
|---------|---------------|----------------|
...
Dùng **Rust OpsClaw** cho triển khai biên (edge) trong sản phẩm. Dùng **opsclaw-tools** khi cần đảm bảo tính nhất quán gọi công cụ hoặc tích hợp hệ sinh thái Python.
