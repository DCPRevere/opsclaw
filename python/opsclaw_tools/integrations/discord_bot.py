"""
Discord bot integration for OpsClaw.
"""
...
class DiscordBot:
    """
    Discord bot powered by OpsClaw agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install opsclaw-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"OpsClaw Discord Bot ready: {self.client.user}")
