use crate::config::schema::{OpsClawAutonomy, TargetConfig, TargetType};
...
fn convert_autonomy(
    autonomy: crate::config::schema::OpsClawAutonomy,
) -> crate::tools::ssh_tool::OpsClawAutonomy {
    match autonomy {
        OpsClawAutonomy::Observe => crate::tools::ssh_tool::OpsClawAutonomy::Observe,
        OpsClawAutonomy::Suggest => crate::tools::ssh_tool::OpsClawAutonomy::Suggest,
        OpsClawAutonomy::ActOnKnown => crate::tools::ssh_tool::OpsClawAutonomy::ActOnKnown,
        OpsClawAutonomy::FullAuto => crate::tools::ssh_tool::OpsClawAutonomy::FullAuto,
    }
}
