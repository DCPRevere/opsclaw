    ...
    match command {
        crate::SkillCommands::List => {
            ...
            if skills.is_empty() {
                ...
                println!();
                println!("  Create one: mkdir -p ~/.opsclaw/workspace/skills/my-skill");
                println!("              echo '# My Skill' > ~/.opsclaw/workspace/skills/my-skill/SKILL.md");
                println!();
...
"#,
    ...
    #[test]
    fn skills_dir_path() {
        let base = std::path::Path::new("/home/user/.opsclaw");
        let dir = skills_dir(base);
        assert_eq!(dir, PathBuf::from("/home/user/.opsclaw/skills"));
    }
